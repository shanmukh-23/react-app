    ...
    return (
        <div className = "container">
         ...
         <div>
                ...
                <span className="nav-text opacity-0">Dashboard</span>
              </div>
              <div>
                <span className="box">
                </span>
                <span className="nav-text opacity-0">ITSM</span>
              </div>
              <div>
                <span className="box">
                </span>
                <span className="nav-text opacity-0">Optix<ArrowDropDownIcon className = "AR"/></span>
              </div>
              <div>
                <span className="box">
                </span>
                <span className="nav-text opacity-0">Hybrid IT<ArrowDropDownIcon className = "AR"/></span>
              </div>
              <div>
                <span className="box">
                </span>
                <span className="nav-text opacity-0">Security</span>
              </div>
              <div>
                <span className="box">
                </span>
                <span className="nav-text opacity-0">Visibility</span>
              </div>
              <div>
                <span className="box">
                </span>
                <span className="nav-text opacity-0">Collaboration</span>
              </div>
              <div>
                <span className="box">
                </span>
                <span className="nav-text opacity-0">Project Management<ArrowDropDownIcon className = "AR"/></span>
              </div>
              <div>
                <span className="box">
                </span>
                <span className="nav-text opacity-0">Alarm Xplorer</span>
              </div>
              <div>
                <span className="box">
                </span>
                <span className="nav-text opacity-0">Settings</span>
              </div>
           
            </div>
            <div className = "bottom">
            <img src={Logo} className = "van" />
        <span className = "bottom-content opacity-0">Powered by VantageX</span>
            </div>
            </div>
)
}
