...
const NN = () => {
    ...
    return (
        <div className = "container">
         ...
         style={{color: "white", fontSize: 30,marginRight: "10px", marginTop: "10px"}}/> :  <MenuIcon  onClick = {closeIcon}  style={{color: "white", fontSize: 30, marginRight: "192px", marginTop: "10px"}}/>}
                 <div className = "vr-name-logout-section">
                  ...
                  <span>Venkateshwar Rao</span>
                  <span><ExitToAppIcon style ={{marginLeft: "10px"}}/></span>
                 </div>
             </div>
            </div>
         ...
         <div>
              ...
              <div>
                ...
                <span className="nav-text">ITSM</span>
              </div>
              <div>
                <span className="box">
                </span>
                <span className="nav-text">Optix</span>
              </div>
              <div>
                <span className="box">
                </span>
                <span className="nav-text">Hybrid IT</span>
              </div>
              <div>
                <span className="box">
                </span>
              ...
              <div>
                ...
                <span className="nav-text">Visibility</span>
              </div>
              <div>
                <span className="box">
                </span>
              ...
              <div>
                ...
                <span className="nav-text">Alarm Xplorer</span>
              </div>
              <div>
                <span className="box">
                </span>
        ...
        <span className = "bottom-content">Powered by VantageX</span>
            </div>
            </div>
)
}
